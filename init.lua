...
require('lazy').setup({
    ...
    -- plenary plugin required as dependency for other plugins
...
-- Remap for deleting but not copyting it to clipboard
...
vim.keymap.set('n', '<leader>p', require('telescope.builtin').find_files, { desc = '[S]earch [P]roject Files' })
